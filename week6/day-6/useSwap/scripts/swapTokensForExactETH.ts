...
const main = async () => {
  ...
  const WETH_ADDR = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2"; // WETH is used for ETH path
  ...
  // 1. Parameters
  const amountOutETH = ethers.parseEther("1"); // I want exactly 1 ETH
  const amountInMaxUSDC = ethers.parseUnits("4000", 6); // Max I will pay is 4000 USDC
  ...
  // 3. Swap
  console.log("Swapping USDC for exactly 1 ETH...");
